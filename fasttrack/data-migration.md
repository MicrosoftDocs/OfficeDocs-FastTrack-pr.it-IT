...
### <a name="migration-service-availability"></a><span data-ttu-id="7d6ff-124">Disponibilità servizio migrazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-124">Migration service availability</span></span>
  ...
  - <span data-ttu-id="7d6ff-125">**Per clienti commerciali e del governo del Regno Unito:** Microsoft offre servizi di migrazione dei dati, 24 ore al giorno, sette (7) giorni alla settimana (24x7).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-125">**For Commercial and UK Government customers:** We provide data migration services 24 hours a day, seven (7) days a week (24x7).</span></span>
...
### <a name="considerations"></a><span data-ttu-id="7d6ff-133">Considerazioni</span><span class="sxs-lookup"><span data-stu-id="7d6ff-133">Considerations</span></span>
  ...
  - <span data-ttu-id="7d6ff-140">Ogni ambiente di origine deve essere al livello di aggiornamento del Service Pack (SP) e del rollup (RU)/aggiornamento cumulativo (CU) per il rispettivo prodotto nell'ambiente di origine.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-140">Each source environment must be on the latest service pack (SP) and rollup (RU)/cumulative update (CU) level for the respective product in the source environment.</span></span>
...
<td><span data-ttu-id="7d6ff-155">Migrazione con distribuzione ibrida</span><span class="sxs-lookup"><span data-stu-id="7d6ff-155">Migration with hybrid deployment</span></span></td>
<td><ul>
...
<td><ul>
<li> <span data-ttu-id="7d6ff-178">Messaggi di posta elettronica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-178">Emails</span></span> </li>
...
<li> <span data-ttu-id="7d6ff-202">Delegati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-202">Delegates</span></span> </li>
...
<span data-ttu-id="7d6ff-219">Gli specialisti di FastTrack eseguono anche le attività seguenti, specifiche della migrazione di Exchange:</span><span class="sxs-lookup"><span data-stu-id="7d6ff-219">Our FastTrack Specialists also perform the following activities, specific to Exchange migrations:</span></span>
  ...
  -  <span data-ttu-id="7d6ff-220">Forniscono indicazioni utili per abilitare la coesistenza di routing della posta SMTP tra gli ambienti di origine e Exchange Online, se applicabile.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-220">Provide guidance to help you enable SMTP mail routing coexistence between your source environments and Exchange Online, if applicable.</span></span>
...
### <a name="source-environment-details"></a><span data-ttu-id="7d6ff-249">Dettagli ambiente di origine</span><span class="sxs-lookup"><span data-stu-id="7d6ff-249">Source environment details</span></span>
...
<li> <span data-ttu-id="7d6ff-270">Creato da</span><span class="sxs-lookup"><span data-stu-id="7d6ff-270">Created by</span></span> </li>
...
<li> <span data-ttu-id="7d6ff-315">Contenuto che appartenente all'account Google Drive che è in corso di migrazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-315">Content not owned by the Google Drive account being migrated</span></span> </li>
...
### <a name="considerations"></a><span data-ttu-id="7d6ff-396">Considerazioni</span><span class="sxs-lookup"><span data-stu-id="7d6ff-396">Considerations</span></span>
...
<td><ul>
<li> <span data-ttu-id="7d6ff-414">Documenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-414">Documents</span></span> </li>
...
<li> <span data-ttu-id="7d6ff-436">Documenti inaccessibili o corrotti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-436">Inaccessible or corrupted documents</span></span> </li>
...
<li> <span data-ttu-id="7d6ff-459">Attributi di blocco di file</span><span class="sxs-lookup"><span data-stu-id="7d6ff-459">File lock attributes</span></span> </li>
...
<li> <span data-ttu-id="7d6ff-492">Conversione degli URL incorporati nel contenuto</span><span class="sxs-lookup"><span data-stu-id="7d6ff-492">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="7d6ff-493">Elementi eliminati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-493">Trashed items</span></span> </li>
<li> <span data-ttu-id="7d6ff-494">Documenti inaccessibili o corrotti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-494">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="7d6ff-495">Utenti bloccati o inattivi</span><span class="sxs-lookup"><span data-stu-id="7d6ff-495">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="7d6ff-496">App Box, Segnalibri, Preferiti e Flussi di lavoro</span><span class="sxs-lookup"><span data-stu-id="7d6ff-496">Box Apps, Bookmarks, Favorites, and Workflows</span></span> </li>
<li> <span data-ttu-id="7d6ff-497">Contenuto non di proprietà dell'account Box migrato</span><span class="sxs-lookup"><span data-stu-id="7d6ff-497">Content not owned by the migrated Box account</span></span> </li>
<li> <span data-ttu-id="7d6ff-498">Autorizzazioni e metadati di base degli utenti esterni ( <strong>Nota</strong>: usare i report di Box per identificare i contenuti condivisi con gli utenti esterni.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-498">Permissions and basic metadata of external users (<strong>Note</strong>: Use Box reports to identify content shared with external users.</span></span> <span data-ttu-id="7d6ff-499">Indicare agli utenti finali di ricondividere i propri contenuti con utenti esterni dopo la migrazione).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-499">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="7d6ff-500">File o cartelle che superano le SharePoint e le limitazioni correnti <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">di Online</span></a> </span><span class="sxs-lookup"><span data-stu-id="7d6ff-500">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="7d6ff-501"><strong>Dropbox per Team (Standard e Advanced)</strong></span><span class="sxs-lookup"><span data-stu-id="7d6ff-501"><strong>Dropbox for Teams (Standard and Advanced)</strong></span></span></td>
<td><span data-ttu-id="7d6ff-502">Passaggio singolo o multiplo</span><span class="sxs-lookup"><span data-stu-id="7d6ff-502">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="7d6ff-503">Documenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-503">Documents</span></span> </li>
<li> <span data-ttu-id="7d6ff-504">Struttura di file e cartelle</span><span class="sxs-lookup"><span data-stu-id="7d6ff-504">File and folder structure</span></span> </li>
<li> <span data-ttu-id="7d6ff-505">Autorizzazioni per cartelle a livello di utente</span><span class="sxs-lookup"><span data-stu-id="7d6ff-505">User-level folder permissions</span></span> </li>
<li> <span data-ttu-id="7d6ff-506">Autorizzazioni per cartelle a livello di gruppo</span><span class="sxs-lookup"><span data-stu-id="7d6ff-506">Group-level folder permissions</span></span> </li>
<li> <span data-ttu-id="7d6ff-507">File inferiori a 15 GB</span><span class="sxs-lookup"><span data-stu-id="7d6ff-507">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="7d6ff-508">Metadati cartella e documenti di base:</span><span class="sxs-lookup"><span data-stu-id="7d6ff-508">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="7d6ff-509">Data creazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-509">Created date</span></span> </li>
<li> <span data-ttu-id="7d6ff-510">Data modifica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-510">Modified date</span></span> </li>
<li> <span data-ttu-id="7d6ff-511">Creato da</span><span class="sxs-lookup"><span data-stu-id="7d6ff-511">Created by</span></span> </li>
<li> <span data-ttu-id="7d6ff-512">Autore ultima modifica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-512">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="7d6ff-513">Contenuto e cartelle del team condiviso</span><span class="sxs-lookup"><span data-stu-id="7d6ff-513">Shared team folders and content</span></span> </li>
<li> <span data-ttu-id="7d6ff-514">Contenuto condiviso appartenente all'account Dropbox in corso di migrazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-514">Shared content owned by the Dropbox account being migrated</span></span> </li>
</ul></td>
<td><ul>
<li> <span data-ttu-id="7d6ff-515">Cronologia di proprietà, versioni precedenti e commenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-515">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="7d6ff-516">Descrizioni di file e cartelle</span><span class="sxs-lookup"><span data-stu-id="7d6ff-516">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="7d6ff-517">Autorizzazioni per file a livello di utente</span><span class="sxs-lookup"><span data-stu-id="7d6ff-517">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="7d6ff-518">Autorizzazioni per file a livello di gruppo</span><span class="sxs-lookup"><span data-stu-id="7d6ff-518">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="7d6ff-519">Metadati avanzati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-519">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="7d6ff-520">Attributi di blocco di file</span><span class="sxs-lookup"><span data-stu-id="7d6ff-520">File lock attributes</span></span> </li>
<li> <span data-ttu-id="7d6ff-521">Conversione degli URL incorporati nel contenuto</span><span class="sxs-lookup"><span data-stu-id="7d6ff-521">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="7d6ff-522">Elementi eliminati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-522">Trashed items</span></span> </li>
<li> <span data-ttu-id="7d6ff-523">Documenti inaccessibili o corrotti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-523">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="7d6ff-524">Cartelle Dropbox non montate</span><span class="sxs-lookup"><span data-stu-id="7d6ff-524">Unmounted Dropbox folders</span></span> </li>
<li> <span data-ttu-id="7d6ff-525">Utenti eliminati o scollegati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-525">Deleted or disconnected users</span></span> </li>
<li> <span data-ttu-id="7d6ff-526">Dropbox Paper, Showcases, e Spaces</span><span class="sxs-lookup"><span data-stu-id="7d6ff-526">Dropbox Paper, Showcases, and Spaces</span></span> </li>
<li> <span data-ttu-id="7d6ff-527">App e preferiti di Dropbox (Pins/stars)</span><span class="sxs-lookup"><span data-stu-id="7d6ff-527">Dropbox Apps and Favorites (Pins/Stars)</span></span> </li>
<li> <span data-ttu-id="7d6ff-528">Contenuto non di proprietà dell'account Dropbox migrato</span><span class="sxs-lookup"><span data-stu-id="7d6ff-528">Content not owned by the migrated Dropbox account</span></span> </li>
<li> <span data-ttu-id="7d6ff-529">Autorizzazioni e metadati di base degli utenti esterni ( <strong>Nota</strong>: usare i report di Dropbox per identificare i contenuti condivisi con gli utenti esterni.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-529">Permissions and basic metadata of external users (<strong>Note</strong>: Use Dropbox reports to identify content shared with external users.</span></span> <span data-ttu-id="7d6ff-530">Indicare agli utenti finali di ricondividere i propri contenuti con utenti esterni dopo la migrazione).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-530">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="7d6ff-531">File o cartelle che superano le SharePoint e le limitazioni correnti <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">di Online</span></a> </span><span class="sxs-lookup"><span data-stu-id="7d6ff-531">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
</tbody>
</table>

## <a name="fasttrack-responsibilities-for-onedrive-for-business-migrations"></a><span data-ttu-id="7d6ff-532">Responsabilità di FastTrack per OneDrive for Business migrazioni</span><span class="sxs-lookup"><span data-stu-id="7d6ff-532">FastTrack responsibilities for OneDrive for Business migrations</span></span>

<span data-ttu-id="7d6ff-533">Gli specialisti di FastTrack eseguono attività standard durante il progetto di migrazione.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-533">Our FastTrack Specialists perform standard activities during the migration project.</span></span> <span data-ttu-id="7d6ff-534">Fare riferimento alle informazioni sulle responsabilità della migrazione dei dati in [Processo e aspettative](process-and-expectations.md) per maggiori dettagli.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-534">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

### <a name="your-responsibilities"></a><span data-ttu-id="7d6ff-535">Responsabilità dell'utente</span><span class="sxs-lookup"><span data-stu-id="7d6ff-535">Your responsibilities</span></span>

<span data-ttu-id="7d6ff-536">Tu esegui attività standard durante il progetto di migrazione.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-536">You perform standard activities during the migration project.</span></span> <span data-ttu-id="7d6ff-537">Fare riferimento alle informazioni sulle responsabilità della migrazione dei dati in [Processo e aspettative](process-and-expectations.md) per maggiori dettagli.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-537">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

<span data-ttu-id="7d6ff-538">Tu esegui anche le attività seguenti, specifiche della migrazione di OneDrive for Business:</span><span class="sxs-lookup"><span data-stu-id="7d6ff-538">You also perform the following activities, specific to OneDrive for Business migrations:</span></span>

  - <span data-ttu-id="7d6ff-539">Esecuzione del provisioning di tutti i siti di OneDrive for Business che verranno assegnati agli eventi di migrazione.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-539">Provision all OneDrive for Business sites that will be targeted by your migration events.</span></span>

## <a name="migration-to-microsoft-teams-and-microsoft-365-groups"></a><span data-ttu-id="7d6ff-540">Migrazione a Microsoft Teams e Microsoft 365 gruppi</span><span class="sxs-lookup"><span data-stu-id="7d6ff-540">Migration to Microsoft Teams and Microsoft 365 Groups</span></span>

<span data-ttu-id="7d6ff-541">Quando si sceglie di usare FastTrack per eseguire la migrazione dei file a Microsoft Teams e Microsoft 365, vengono fornite indicazioni sulla migrazione e servizi di migrazione dei dati.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-541">When you choose to use FastTrack to migrate your files to Microsoft Teams and Microsoft 365 Groups, we provide migration guidance and data migration services.</span></span> <span data-ttu-id="7d6ff-542">Vengono fornite indicazioni per pianificare la migrazione, configurare gli ambienti di origine e i gruppi Teams e Microsoft 365 e sfruttare i servizi di migrazione dei dati per eseguire la migrazione dei file.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-542">We provide guidance to help you plan your migration, configure your source environments and Teams and Microsoft 365 Groups, and leverage our data migration services to migrate your files.</span></span> <span data-ttu-id="7d6ff-543">Crea e pianifica gli eventi di migrazione.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-543">You create and schedule your migration events.</span></span> <span data-ttu-id="7d6ff-544">Avviamo gli eventi di migrazione in base alla programmazione, monitorando lo stato di avanzamento e fornendo relazioni sullo stato.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-544">We launch migration events in accordance with your schedule, monitor their progress, and provide status reports.</span></span> <span data-ttu-id="7d6ff-545">Una volta completati gli eventi di migrazione, è possibile prevedere la migrazione dei file delle origini pianificate e idonee degli ambienti di origine in Teams e Microsoft 365 gruppi.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-545">When your migration events are completed, you can expect files from appropriately scheduled and eligible sources of your source environments to have been migrated to Teams and Microsoft 365 Groups.</span></span> <span data-ttu-id="7d6ff-546">Teams e i Microsoft 365 devono essere pre-provisioning dal cliente prima di poter eseguire la migrazione dei dati in questi tipi di destinazione.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-546">Teams channels and Microsoft 365 Groups  must be pre-provisioned by the customer before they can migrate data into these destination types.</span></span> <span data-ttu-id="7d6ff-547">Teams e Microsoft 365 gruppi influiscono sulle autorizzazioni sul percorso di destinazione del file.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-547">Teams and Microsoft 365 Groups impacts your permissions on the file destination location.</span></span> <span data-ttu-id="7d6ff-548">Teams e Microsoft 365 sono creati per consentire la collaborazione.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-548">Teams and Microsoft 365 Groups are built to allow collaboration.</span></span> <span data-ttu-id="7d6ff-549">Il Teams o il Microsoft 365 determinano chi ha accesso a tali file durante la migrazione in tali destinazioni.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-549">The Teams channel or Microsoft 365 group determine who has access to those files when migrating into those destinations.</span></span> <span data-ttu-id="7d6ff-550">FastTrack non aggiunge utenti finali o gruppi ad alcun canale Teams o Microsoft 365 gruppi durante la migrazione.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-550">FastTrack doesn't add end users or groups to any Teams channel or Microsoft 365 Groups permission during migration.</span></span>

### <a name="considerations"></a><span data-ttu-id="7d6ff-551">Considerazioni</span><span class="sxs-lookup"><span data-stu-id="7d6ff-551">Considerations</span></span>

- <span data-ttu-id="7d6ff-552">Tutte le migrazioni sono soggette a quote di SharePoint Online.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-552">All migrations are subject to SharePoint Online quotas.</span></span> <span data-ttu-id="7d6ff-553">Per informazioni <a href="https://go.microsoft.com/fwlink/?LinkId=698855">dettagliate, SharePoint limiti</a> di sicurezza.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-553">Refer to <a href="https://go.microsoft.com/fwlink/?LinkId=698855"> SharePoint limits</a> for details.</span></span> 
- <span data-ttu-id="7d6ff-554">È consigliabile limitare l'importo complessivo della migrazione al 75% della quota complessiva di SharePoint Online a cui si ha diritto (incluso lo spazio di archiviazione aggiuntivo acquistato separatamente).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-554">We recommend that you limit the overall amount of migrate to 75 percent of the overall SharePoint Online storage quota to which you are entitled (including the additional storage you may have purchased separately).</span></span> 


### <a name="source-environment-details"></a><span data-ttu-id="7d6ff-555">Dettagli ambiente di origine</span><span class="sxs-lookup"><span data-stu-id="7d6ff-555">Source environment details</span></span>

<span data-ttu-id="7d6ff-556">Il servizio di migrazione dei dati esegue la migrazione dai seguenti ambienti di origine:</span><span class="sxs-lookup"><span data-stu-id="7d6ff-556">Our data migration services migrate data from these source environments:</span></span> 

- <span data-ttu-id="7d6ff-557">Condivisioni di file (condivisioni di file di Server Message Block su dispositivi che supportano SMB 2.0 e versioni successive).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-557">File shares (Server Message Block (SMB) file shares on devices supporting SMB 2.0 onward).</span></span>
-  <span data-ttu-id="7d6ff-558">Un singolo ambiente di G Suite (soltanto Google Drive).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-558">A single G Suite environment (Google Drive only).</span></span> 
- <span data-ttu-id="7d6ff-559">Box (Starter, Business, Enterprise).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-559">Box (Starter, Business, Enterprise).</span></span> 
- <span data-ttu-id="7d6ff-560">Dropbox per Team (Standard e Advanced).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-560">Dropbox for Teams (Standard and Advanced).</span></span> 

<span data-ttu-id="7d6ff-561">Nella tabella seguente vengono illustrati i dettagli della migrazione specifici per ogni ambiente di origine:</span><span class="sxs-lookup"><span data-stu-id="7d6ff-561">The following table presents migration details specific to each source environment:</span></span>

<table>
<thead>
<tr class="header">
 <th><span data-ttu-id="7d6ff-562"><strong>Ambiente di origine</strong></span><span class="sxs-lookup"><span data-stu-id="7d6ff-562"><strong>Source environment</strong></span></span></th>
 <th><span data-ttu-id="7d6ff-563"><strong>Tipo di migrazione</strong></span><span class="sxs-lookup"><span data-stu-id="7d6ff-563"><strong>Type of migration</strong></span></span></th>
 <th><span data-ttu-id="7d6ff-564"><strong>Cosa migra</strong></span><span class="sxs-lookup"><span data-stu-id="7d6ff-564"><strong>What migrates</strong></span></span></th>
 <th><span data-ttu-id="7d6ff-565"><strong>Cosa non migra</strong></span><span class="sxs-lookup"><span data-stu-id="7d6ff-565"><strong>What doesn't migrate</strong></span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><span data-ttu-id="7d6ff-566"><strong>Qualsiasi dispositivo di condivisione file che supporta SMB 2.0 e versioni successive</strong></span><span class="sxs-lookup"><span data-stu-id="7d6ff-566"><strong>Any file share device supporting SMB 2.0 onward</strong></span></span></td>
<td><span data-ttu-id="7d6ff-567">Passaggio singolo o multiplo</span><span class="sxs-lookup"><span data-stu-id="7d6ff-567">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="7d6ff-568">Documenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-568">Documents</span></span> </li>
<li> <span data-ttu-id="7d6ff-569">Struttura di file e cartelle</span><span class="sxs-lookup"><span data-stu-id="7d6ff-569">File and folder structure</span></span> </li>
<li> <span data-ttu-id="7d6ff-570">Autorizzazioni per file e cartelle a livello di utente\*</span><span class="sxs-lookup"><span data-stu-id="7d6ff-570">User-level file and folder permissions\*</span></span> </li>
<li> <span data-ttu-id="7d6ff-571">Autorizzazioni per file e cartelle a livello di gruppo\*</span><span class="sxs-lookup"><span data-stu-id="7d6ff-571">Group-level file and folder permissions\*</span></span> </li>
<li> <span data-ttu-id="7d6ff-572">File inferiori a 15 GB</span><span class="sxs-lookup"><span data-stu-id="7d6ff-572">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="7d6ff-573">Metadati cartella e documenti di base:</span><span class="sxs-lookup"><span data-stu-id="7d6ff-573">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="7d6ff-574">Data creazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-574">Created date</span></span> </li>
<li> <span data-ttu-id="7d6ff-575">Data modifica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-575">Modified date</span></span> </li>
<li> <span data-ttu-id="7d6ff-576">Creato da</span><span class="sxs-lookup"><span data-stu-id="7d6ff-576">Created by</span></span> </li>
<li> <span data-ttu-id="7d6ff-577">Autore ultima modifica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-577">Last modified by</span></span> </li>
</ul></li>
</ul>
<br>
<span data-ttu-id="7d6ff-578">\*Configurazione della sincronizzazione della directory necessaria.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-578">\*Directory synchronization configuration required.</span></span> <span data-ttu-id="7d6ff-579">Vengono migrate solo le autorizzazioni NTFS esposte a Esplora file di Windows.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-579">Only NTFS permissions exposed to the Windows File Explorer are migrated.</span></span> <span data-ttu-id="7d6ff-580">Le autorizzazioni gestite direttamente nei dispositivi di condivisione dei file non vengono migrate.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-580">Permissions managed directly on file share devices are not migrated.</span></span> <span data-ttu-id="7d6ff-581">Se i dati sono archiviati su un dispositivo SMB 2.0, vengono migrate le autorizzazioni equivalenti a NTFS esposte dal protocollo SMB.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-581">If data is stored on an SMB 2.0 device, the NTFS-equivalent permissions exposed by the SMB protocol are migrated.</span></span> <span data-ttu-id="7d6ff-582">Le autorizzazioni sono influenzate dal Microsoft 365 e/o Microsoft Teams canale.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-582">Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="7d6ff-583">Se la destinazione è un Microsoft 365 gruppo o Microsoft Teams, il gruppo o il canale determina il profilo delle autorizzazioni finali per i file migrati.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-583">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="7d6ff-584">È consigliabile non eseguire la migrazione delle autorizzazioni per la migrazione dei file a un Microsoft 365 gruppo o Microsoft Teams canale.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-584">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span></td>
<td><ul>
<li> <span data-ttu-id="7d6ff-585">Cronologia di proprietà e versioni precedenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-585">Ownership history and previous versions</span></span> </li>
<li> <span data-ttu-id="7d6ff-586">Conversione degli URL incorporati nel contenuto</span><span class="sxs-lookup"><span data-stu-id="7d6ff-586">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="7d6ff-587">Versioni precedenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-587">Previous versions</span></span> </li>
<li> <span data-ttu-id="7d6ff-588">File di Windows e attributi di cartella (come Di sola lettura e Nascosto)</span><span class="sxs-lookup"><span data-stu-id="7d6ff-588">Windows file and folder attributes (like read-only and hidden)</span></span> </li>
<li> <span data-ttu-id="7d6ff-589">Impostazioni avanzate e autorizzazioni speciali non Windows New Technology File System (NTFS):</span><span class="sxs-lookup"><span data-stu-id="7d6ff-589">Non-Windows New Technology File System (NTFS) and NTFS advanced permissions and special settings:</span></span> </li>
<li> <span data-ttu-id="7d6ff-590">Autorizzazioni di negazione esplicita (contenuto rimosso dopo la migrazione, contenuto soggetto ad autorizzazioni parallele o autorizzazioni sulla cartella padre)</span><span class="sxs-lookup"><span data-stu-id="7d6ff-590">Explicit deny permissions (removed after migration, content subject to parallel permissions or permissions on parent folder)</span></span> </li>
<li> <span data-ttu-id="7d6ff-591">Configurazione di controllo NTFS</span><span class="sxs-lookup"><span data-stu-id="7d6ff-591">NTFS auditing configuration</span></span> </li>
<li> <span data-ttu-id="7d6ff-592">Metadati di file aggiuntivi forniti dall'Infrastruttura di classificazione file (FCI)</span><span class="sxs-lookup"><span data-stu-id="7d6ff-592">Additional file metadata provided by File Classification Infrastructure (FCI)</span></span> </li>
<li> <span data-ttu-id="7d6ff-593">Documenti inaccessibili o corrotti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-593">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="7d6ff-594">Condivisioni nascoste</span><span class="sxs-lookup"><span data-stu-id="7d6ff-594">Hidden shares</span></span> </li>
<li> <span data-ttu-id="7d6ff-595">Condivisione (come autorizzazioni concesse a livello di condivisione)</span><span class="sxs-lookup"><span data-stu-id="7d6ff-595">Sharing (like permissions granted on the share level)</span></span> </li>
<li> <span data-ttu-id="7d6ff-596">File o cartelle che superano le SharePoint e le limitazioni correnti <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">di Online</span></a> </span><span class="sxs-lookup"><span data-stu-id="7d6ff-596">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="7d6ff-597"><strong>Ambiente G Suite singolo (solo Google Drive)</strong></span><span class="sxs-lookup"><span data-stu-id="7d6ff-597"><strong>Single G Suite environment (Google Drive only)</strong></span></span></td>
<td><span data-ttu-id="7d6ff-598">Passaggio singolo o multiplo</span><span class="sxs-lookup"><span data-stu-id="7d6ff-598">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="7d6ff-599">Documenti, Fogli e Presentazioni Google (i file sono convertiti al formato Office equivalente, anche quelli di oltre 10 MB)</span><span class="sxs-lookup"><span data-stu-id="7d6ff-599">Google Docs, Sheets, and Slides (files are converted to the equivalent Office format including those over 10 MB)</span></span> </li>
<li> <span data-ttu-id="7d6ff-600">Struttura di file e cartelle</span><span class="sxs-lookup"><span data-stu-id="7d6ff-600">File and folder structure</span></span> </li>
<li> <span data-ttu-id="7d6ff-601">Autorizzazioni per le cartelle a livello di utente\*</span><span class="sxs-lookup"><span data-stu-id="7d6ff-601">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="7d6ff-602">Autorizzazioni cartella a livello di gruppo\*</span><span class="sxs-lookup"><span data-stu-id="7d6ff-602">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="7d6ff-603">File inferiori a 15 GB</span><span class="sxs-lookup"><span data-stu-id="7d6ff-603">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="7d6ff-604">Metadati cartella e documenti di base:</span><span class="sxs-lookup"><span data-stu-id="7d6ff-604">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="7d6ff-605">Data creazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-605">Created date</span></span> </li>
<li> <span data-ttu-id="7d6ff-606">Data modifica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-606">Modified date</span></span> </li>
<li> <span data-ttu-id="7d6ff-607">Creato da</span><span class="sxs-lookup"><span data-stu-id="7d6ff-607">Created by</span></span> </li>
<li> <span data-ttu-id="7d6ff-608">Autore ultima modifica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-608">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="7d6ff-609">Unità condivise (cartelle e file)</span><span class="sxs-lookup"><span data-stu-id="7d6ff-609">Shared drives (folders and files)</span></span> </li>
<li> <span data-ttu-id="7d6ff-610">Contenuto condiviso appartenente all'account Google Drive in corso di migrazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-610">Shared content owned by the Google Drive account being migrated</span></span> </li>
</ul>
<br>
<span data-ttu-id="7d6ff-611">\*Le autorizzazioni sono influenzate dal Microsoft 365 gruppo e/o Microsoft Teams canale.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-611">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="7d6ff-612">Se la destinazione è un Microsoft 365 gruppo o Microsoft Teams, il gruppo o il canale determina il profilo delle autorizzazioni finali per i file migrati.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-612">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="7d6ff-613">È consigliabile non eseguire la migrazione delle autorizzazioni per la migrazione dei file a un Microsoft 365 gruppo o Microsoft Teams canale.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-613">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span> 
</td>
<td><ul>
<li> <span data-ttu-id="7d6ff-614">Cronologia di proprietà, versioni precedenti e commenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-614">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="7d6ff-615">Descrizioni di file e cartelle, colori delle cartelle</span><span class="sxs-lookup"><span data-stu-id="7d6ff-615">File and folder descriptions, folder colors</span></span> </li>
<li> <span data-ttu-id="7d6ff-616">Autorizzazioni per file a livello di utente</span><span class="sxs-lookup"><span data-stu-id="7d6ff-616">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="7d6ff-617">Autorizzazioni per file a livello di gruppo</span><span class="sxs-lookup"><span data-stu-id="7d6ff-617">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="7d6ff-618">Metadati avanzati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-618">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="7d6ff-619">Attributi di blocco di file</span><span class="sxs-lookup"><span data-stu-id="7d6ff-619">File lock attributes</span></span> </li>
<li> <span data-ttu-id="7d6ff-620">Conversione degli URL incorporati nel contenuto</span><span class="sxs-lookup"><span data-stu-id="7d6ff-620">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="7d6ff-621">Elementi eliminati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-621">Trashed items</span></span> </li>
<li> <span data-ttu-id="7d6ff-622">Documenti inaccessibili o corrotti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-622">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="7d6ff-623">Utenti bloccati o inattivi</span><span class="sxs-lookup"><span data-stu-id="7d6ff-623">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="7d6ff-624">Google Photos, Moduli, Maps e altre app connesse</span><span class="sxs-lookup"><span data-stu-id="7d6ff-624">Google Photos Forms, Maps, and other connected apps</span></span> </li>
<li> <span data-ttu-id="7d6ff-625">Disegni Google</span><span class="sxs-lookup"><span data-stu-id="7d6ff-625">Google Drawings</span></span> </li>
<li> <span data-ttu-id="7d6ff-626">Contenuti condivisi esterni alla tua impresa</span><span class="sxs-lookup"><span data-stu-id="7d6ff-626">Shared content external to your organization</span></span> </li>
<li> <span data-ttu-id="7d6ff-627">Contenuto che appartenente all'account Google Drive che è in corso di migrazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-627">Content not owned by the Google Drive account being migrated</span></span> </li>
<li> <span data-ttu-id="7d6ff-628">Autorizzazioni e metadati di base degli utenti esterni ( <strong>Nota</strong>: usare i report di Google Drive Admin per identificare i contenuti condivisi con gli utenti esterni.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-628">Permissions and basic metadata of external users (<strong>Note</strong>: Use Google Drive Admin reports to identify content shared with external users.</span></span> <span data-ttu-id="7d6ff-629">Indicare agli utenti finali di ricondividere i propri contenuti con utenti esterni dopo la migrazione).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-629">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="7d6ff-630">Autorizzazioni di appartenenza alle unità condivisa (<strong>Nota</strong>: usare i report amministratore di Google Drive per identificare l’appartenenza alle unità condivise.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-630">Shared drive membership permissions (<strong>Note</strong>: Use Google Drive Admin reports to identify shared drive memberships.</span></span> <span data-ttu-id="7d6ff-631">Indicare agli utenti finali di configurare queste impostazioni di appartenenza nella destinazione prima della migrazione).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-631">Instruct end users to configure these membership settings on the target before migration.)</span></span> </li>
<li> <span data-ttu-id="7d6ff-632">File o cartelle che superano le SharePoint e le limitazioni correnti <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">di Online</span></a> </span><span class="sxs-lookup"><span data-stu-id="7d6ff-632">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="7d6ff-633"><strong>Box (Starter, Business, Enterprise)</strong></span><span class="sxs-lookup"><span data-stu-id="7d6ff-633"><strong>Box (Starter, Business, Enterprise)</strong></span></span></td>
<td><span data-ttu-id="7d6ff-634">Passaggio singolo o multiplo</span><span class="sxs-lookup"><span data-stu-id="7d6ff-634">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="7d6ff-635">Documenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-635">Documents</span></span> </li>
<li> <span data-ttu-id="7d6ff-636">Struttura di file e cartelle</span><span class="sxs-lookup"><span data-stu-id="7d6ff-636">File and folder structure</span></span> </li>
<li> <span data-ttu-id="7d6ff-637">Autorizzazioni per le cartelle a livello di utente\*</span><span class="sxs-lookup"><span data-stu-id="7d6ff-637">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="7d6ff-638">Autorizzazioni cartella a livello di gruppo\*</span><span class="sxs-lookup"><span data-stu-id="7d6ff-638">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="7d6ff-639">File inferiori a 15 GB</span><span class="sxs-lookup"><span data-stu-id="7d6ff-639">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="7d6ff-640">Metadati cartella e documenti di base:</span><span class="sxs-lookup"><span data-stu-id="7d6ff-640">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="7d6ff-641">Data creazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-641">Created date</span></span> </li>
<li> <span data-ttu-id="7d6ff-642">Data modifica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-642">Modified date</span></span> </li>
<li> <span data-ttu-id="7d6ff-643">Creato da</span><span class="sxs-lookup"><span data-stu-id="7d6ff-643">Created by</span></span> </li>
<li> <span data-ttu-id="7d6ff-644">Autore ultima modifica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-644">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="7d6ff-645">Contenuto condiviso appartenente all'account Box in corso di migrazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-645">Shared content owned by the Box account being migrated</span></span> </li>
<li> <span data-ttu-id="7d6ff-646">Note casella (convertite in formato documento Word)</span><span class="sxs-lookup"><span data-stu-id="7d6ff-646">Box Notes (converted to Word document format)</span></span> </li>
</ul>
<br>
<span data-ttu-id="7d6ff-647">\*Le autorizzazioni sono influenzate dal Microsoft 365 gruppo e/o Microsoft Teams canale.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-647">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="7d6ff-648">Se la destinazione è un Microsoft 365 gruppo o Microsoft Teams, il gruppo o il canale determina il profilo delle autorizzazioni finali per i file migrati.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-648">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="7d6ff-649">È consigliabile non eseguire la migrazione delle autorizzazioni per la migrazione dei file a un Microsoft 365 gruppo o Microsoft Teams canale.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-649">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span> </td>
<td><ul>
<li> <span data-ttu-id="7d6ff-650">Cronologia di proprietà, versioni precedenti e commenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-650">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="7d6ff-651">Descrizioni di file e cartelle</span><span class="sxs-lookup"><span data-stu-id="7d6ff-651">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="7d6ff-652">Autorizzazioni per file a livello di utente</span><span class="sxs-lookup"><span data-stu-id="7d6ff-652">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="7d6ff-653">Autorizzazioni per file a livello di gruppo</span><span class="sxs-lookup"><span data-stu-id="7d6ff-653">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="7d6ff-654">Tag Box e metadati avanzati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-654">Box Tags and advanced metadata</span></span> </li>
<li> <span data-ttu-id="7d6ff-655">Attributi di blocco di file</span><span class="sxs-lookup"><span data-stu-id="7d6ff-655">File lock attributes</span></span> </li>
<li> <span data-ttu-id="7d6ff-656">Conversione degli URL incorporati nel contenuto</span><span class="sxs-lookup"><span data-stu-id="7d6ff-656">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="7d6ff-657">Elementi eliminati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-657">Trashed items</span></span> </li>
<li> <span data-ttu-id="7d6ff-658">Documenti inaccessibili o corrotti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-658">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="7d6ff-659">Utenti bloccati o inattivi</span><span class="sxs-lookup"><span data-stu-id="7d6ff-659">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="7d6ff-660">App Box, Segnalibri, Preferiti e Flussi di lavoro</span><span class="sxs-lookup"><span data-stu-id="7d6ff-660">Box Apps, Bookmarks, Favorites, and Workflows</span></span> </li>
<li> <span data-ttu-id="7d6ff-661">Contenuto non di proprietà dell'account Box migrato</span><span class="sxs-lookup"><span data-stu-id="7d6ff-661">Content not owned by the migrated Box account</span></span> </li>
<li> <span data-ttu-id="7d6ff-662">Autorizzazioni e metadati di base degli utenti esterni ( <strong>Nota</strong>: usare i report di Box per identificare i contenuti condivisi con gli utenti esterni.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-662">Permissions and basic metadata of external users (<strong>Note</strong>: Use Box reports to identify content shared with external users.</span></span> <span data-ttu-id="7d6ff-663">Indicare agli utenti finali di ricondividere i propri contenuti con utenti esterni dopo la migrazione).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-663">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="7d6ff-664">File o cartelle che superano le SharePoint e le limitazioni correnti <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">di Online</span></a> </span><span class="sxs-lookup"><span data-stu-id="7d6ff-664">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="7d6ff-665"><strong>Dropbox per Team (Standard e Advanced)</strong></span><span class="sxs-lookup"><span data-stu-id="7d6ff-665"><strong>Dropbox for Teams (Standard and Advanced)</strong></span></span></td>
<td><span data-ttu-id="7d6ff-666">Passaggio singolo o multiplo</span><span class="sxs-lookup"><span data-stu-id="7d6ff-666">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="7d6ff-667">Documenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-667">Documents</span></span> </li>
<li> <span data-ttu-id="7d6ff-668">Struttura di file e cartelle</span><span class="sxs-lookup"><span data-stu-id="7d6ff-668">File and folder structure</span></span> </li>
<li> <span data-ttu-id="7d6ff-669">Autorizzazioni per le cartelle a livello di utente\*</span><span class="sxs-lookup"><span data-stu-id="7d6ff-669">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="7d6ff-670">Autorizzazioni cartella a livello di gruppo\*</span><span class="sxs-lookup"><span data-stu-id="7d6ff-670">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="7d6ff-671">File inferiori a 15 GB</span><span class="sxs-lookup"><span data-stu-id="7d6ff-671">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="7d6ff-672">Metadati cartella e documenti di base:</span><span class="sxs-lookup"><span data-stu-id="7d6ff-672">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="7d6ff-673">Data creazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-673">Created date</span></span> </li>
<li> <span data-ttu-id="7d6ff-674">Data modifica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-674">Modified date</span></span> </li>
<li> <span data-ttu-id="7d6ff-675">Creato da</span><span class="sxs-lookup"><span data-stu-id="7d6ff-675">Created by</span></span> </li>
<li> <span data-ttu-id="7d6ff-676">Autore ultima modifica</span><span class="sxs-lookup"><span data-stu-id="7d6ff-676">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="7d6ff-677">Contenuto e cartelle del team condiviso</span><span class="sxs-lookup"><span data-stu-id="7d6ff-677">Shared team folders and content</span></span> </li>
<li> <span data-ttu-id="7d6ff-678">Contenuto condiviso appartenente all'account Dropbox in corso di migrazione</span><span class="sxs-lookup"><span data-stu-id="7d6ff-678">Shared content owned by the Dropbox account being migrated</span></span> </li>
</ul>
<br>
<span data-ttu-id="7d6ff-679">\*Le autorizzazioni sono influenzate dal Microsoft 365 gruppo e/o Microsoft Teams canale.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-679">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="7d6ff-680">Se la destinazione è un Microsoft 365 gruppo o Microsoft Teams, il gruppo o il canale determina il profilo delle autorizzazioni finali per i file migrati.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-680">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="7d6ff-681">È consigliabile non eseguire la migrazione delle autorizzazioni per la migrazione dei file a un Microsoft 365 gruppo o Microsoft Teams canale.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-681">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span>
</td>
<td><ul>
<li> <span data-ttu-id="7d6ff-682">Cronologia di proprietà, versioni precedenti e commenti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-682">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="7d6ff-683">Descrizioni di file e cartelle</span><span class="sxs-lookup"><span data-stu-id="7d6ff-683">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="7d6ff-684">Autorizzazioni per file a livello di utente</span><span class="sxs-lookup"><span data-stu-id="7d6ff-684">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="7d6ff-685">Autorizzazioni per file a livello di gruppo</span><span class="sxs-lookup"><span data-stu-id="7d6ff-685">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="7d6ff-686">Metadati avanzati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-686">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="7d6ff-687">Attributi di blocco di file</span><span class="sxs-lookup"><span data-stu-id="7d6ff-687">File lock attributes</span></span> </li>
<li> <span data-ttu-id="7d6ff-688">Conversione degli URL incorporati nel contenuto</span><span class="sxs-lookup"><span data-stu-id="7d6ff-688">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="7d6ff-689">Elementi eliminati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-689">Trashed items</span></span> </li>
<li> <span data-ttu-id="7d6ff-690">Documenti inaccessibili o corrotti</span><span class="sxs-lookup"><span data-stu-id="7d6ff-690">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="7d6ff-691">Cartelle Dropbox non montate</span><span class="sxs-lookup"><span data-stu-id="7d6ff-691">Unmounted Dropbox folders</span></span> </li>
<li> <span data-ttu-id="7d6ff-692">Utenti eliminati o scollegati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-692">Deleted or disconnected users</span></span> </li>
<li> <span data-ttu-id="7d6ff-693">Dropbox Paper, Showcases, e Spaces</span><span class="sxs-lookup"><span data-stu-id="7d6ff-693">Dropbox Paper, Showcases, and Spaces</span></span> </li>
<li> <span data-ttu-id="7d6ff-694">App e preferiti di Dropbox (Pins/stars)</span><span class="sxs-lookup"><span data-stu-id="7d6ff-694">Dropbox Apps and Favorites (Pins/Stars)</span></span> </li>
<li> <span data-ttu-id="7d6ff-695">Contenuto non di proprietà dell'account Dropbox migrato</span><span class="sxs-lookup"><span data-stu-id="7d6ff-695">Content not owned by the migrated Dropbox account</span></span> </li>
<li> <span data-ttu-id="7d6ff-696">Autorizzazioni e metadati di base degli utenti esterni ( <strong>Nota</strong>: usare i report di Dropbox per identificare i contenuti condivisi con gli utenti esterni.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-696">Permissions and basic metadata of external users (<strong>Note</strong>: Use Dropbox reports to identify content shared with external users.</span></span> <span data-ttu-id="7d6ff-697">Indicare agli utenti finali di ricondividere i propri contenuti con utenti esterni dopo la migrazione).</span><span class="sxs-lookup"><span data-stu-id="7d6ff-697">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="7d6ff-698">File o cartelle che superano le SharePoint e le limitazioni correnti <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">di Online</span></a> </span><span class="sxs-lookup"><span data-stu-id="7d6ff-698">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
</tbody>
</table>

## <a name="fasttrack-responsibilities-for-microsoft-teams-and-microsoft-365-groups-migrations"></a><span data-ttu-id="7d6ff-699">Responsabilità di FastTrack per le migrazioni Microsoft Teams e Microsoft 365 gruppi</span><span class="sxs-lookup"><span data-stu-id="7d6ff-699">FastTrack responsibilities for Microsoft Teams and Microsoft 365 Groups migrations</span></span>

<span data-ttu-id="7d6ff-700">Gli specialisti di FastTrack eseguono attività standard durante il progetto di migrazione.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-700">Our FastTrack Specialists perform standard activities during the migration project.</span></span> <span data-ttu-id="7d6ff-701">Fare riferimento alle informazioni sulle responsabilità della migrazione dei dati in [Processo e aspettative](process-and-expectations.md) per maggiori dettagli.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-701">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

### <a name="your-responsibilities"></a><span data-ttu-id="7d6ff-702">Responsabilità dell'utente</span><span class="sxs-lookup"><span data-stu-id="7d6ff-702">Your responsibilities</span></span> 

<span data-ttu-id="7d6ff-703">Tu esegui attività standard durante il progetto di migrazione.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-703">You perform standard activities during the migration project.</span></span> <span data-ttu-id="7d6ff-704">Fare riferimento alle informazioni sulle responsabilità della migrazione dei dati in [Processo e aspettative](process-and-expectations.md) per maggiori dettagli.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-704">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>
<span data-ttu-id="7d6ff-705">È inoltre possibile eseguire le attività seguenti, specifiche per le migrazioni Microsoft Teams e Microsoft 365 gruppi:</span><span class="sxs-lookup"><span data-stu-id="7d6ff-705">You also perform the following activities, specific to Microsoft Teams and Microsoft 365 Groups migrations:</span></span> 

- <span data-ttu-id="7d6ff-706">Esegui il provisioning di Microsoft Teams canali e Microsoft 365 gruppi come destinazione degli eventi di migrazione.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-706">Provision all Microsoft Teams channels and Microsoft 365 Groups as targeted by your migration events.</span></span>

> [!NOTE]
><span data-ttu-id="7d6ff-707">FastTrack non effettua il pre-provisioning Microsoft Teams canali o Microsoft 365 gruppi.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-707">FastTrack doesn't pre-provision Microsoft Teams channels or Microsoft 365 Groups.</span></span> <span data-ttu-id="7d6ff-708">FastTrack non aggiunge utenti finali o gruppi a Microsoft Teams o Microsoft 365 gruppi.</span><span class="sxs-lookup"><span data-stu-id="7d6ff-708">FastTrack doesn't add end users or groups to Microsoft Teams channels or Microsoft 365 Groups.</span></span> <span data-ttu-id="7d6ff-709">È necessario aggiungere gli utenti finali o i gruppi a tutti i canali Microsoft Teams e i gruppi di Microsoft 365 prima di eseguire la migrazione dei dati in tali destinazioni in modo che tali utenti finali hanno accesso ai documenti appena migrati</span><span class="sxs-lookup"><span data-stu-id="7d6ff-709">You must add your end users or groups to all Microsoft Teams channels and Microsoft 365 Groups before you migrate data into those destinations so those end users have access to those newly migrated documents</span></span>