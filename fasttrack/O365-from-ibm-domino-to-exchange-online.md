...
- FastTrack Center: 
    - Configura l'ambiente di migrazione in Azure.  
    - Configura gli strumenti di migrazione sulle workstation amministrative locali. 
    - Configura e mostra come utilizzare lo strumento di importazione automatica.  
    - Esegue la convalida di tutti i componenti della migrazione ed esegue le migrazioni di prova.
...
- FastTrack Center:
    - Esegue migrazioni pilota e su vasta scala.  
    - Esegue eventi di migrazione e attività "T-minus".
    - Fornisce supporto post-migrazione.
