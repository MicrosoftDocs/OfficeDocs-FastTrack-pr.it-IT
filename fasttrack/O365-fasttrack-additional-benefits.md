...
I clienti che acquistano almeno 20.000 licenze per un tenant di Exchange Online possono ottenere i servizi aggiuntivi di FastTrack Center. Per altre informazioni, vedere [Idoneità](eligibility.md). 
...
Gli esperti di FastTrack hanno le seguenti responsabilità durante la procedura di onboarding. Tali responsabilità possono aggiungersi o sostituire le attività definite in[Processi e aspettative](process-and-expectations.md).
  
## <a name="general"></a>Generale

- Fornire assistenza al supporto remoto per un corretto sviluppo della pianificazione, implementazione e per le necessarie attività di configurazione, come descritto in [Prodotti e funzionalità](products-and-capabilities.md).
...
Ecco le responsabilità dell'utente durante il processo di onboarding. Si tratta di responsabilità che vanno ad aggiungersi a quelle definite nella sezione [Processi e aspettative](process-and-expectations.md). 
