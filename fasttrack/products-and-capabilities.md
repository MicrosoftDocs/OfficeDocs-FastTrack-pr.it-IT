...
<tr class="odd">
<td><strong>Gestione dei rischi Insider</strong></td>
...
<li> Revisione dei dashboard di Cloud App Security cloud e Cloud Discovery.</li>
...
<li> Protezione delle app con controllo dell'app di accesso condizionale nell'accesso condizionale all'interno di Azure AD Cloud App Security portali.</li>
...
<li> Gestione dei progetti delle attività di correzione del cliente.</li>
<li> Gestione continua, risposta alle minacce e correzione. </li>
<li> Discussioni che Cloud App Security confronto con altre offerte CASB.</li>
...
<li> Microsoft Defender SmartScreen configurazione tramite Microsoft Endpoint Manager.</li>
...
Per informazioni sull'uso del vantaggio FastTrack per la migrazione dei dati Office 365, vedere <a href="/fasttrack/data-migration">Data Migration</a>.   
...
<td><strong>Microsoft Defender per Office 365</strong></td>
<td>  Per altre informazioni, vedi <strong>Microsoft Defender per Office 365</strong> sicurezza e <a href="/fasttrack/products-and-capabilities#security-and-compliance">conformità.</a>  
</td>
<td></td>
</tr>
...
<td><strong>Microsoft Information Protection</strong></td>
<td>  
Per ulteriori informazioni, vedere <strong>Microsoft Information Protection</strong> in <a href="/fasttrack/products-and-capabilities#security-and-compliance">Sicurezza e conformità.</a>
...
<li>  Protezione Outlook dispositivi mobili (per ulteriori informazioni, vedere <a href="/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/secure-outlook-for-ios-and-android">Securing Outlook for iOS and Android in Exchange Online).</a>  </li>
</ul></td>
<td><ul>
<li>  Identità abilitate in Azure AD per Office 365.  </li>
...
<li>  La versione di Configuration Manager deve essere supportata dalla Windows 10 di destinazione. Per altre informazioni, vedere la tabella di supporto di Configuration Manager in <a href="/sccm/core/plan-design/configs/support-for-windows-10">Supporto per Windows 10 in Configuration Manager</a>.  </li>
</ul>
...
<ul>
<li>La distribuzione Windows 10 Enterprise multi-sessione e Microsoft 365 Apps per Enterprise utilizzando quanto segue:
<ul>
<li>Immagine di Azure Marketplace.</li>
<li>Immagine condivisa.</li>
<li>Office Deployment Toolkit (ODT).</li>
</ul></li>
<li>Configurazione di Microsoft 365 Apps per FSLogix in un desktop Windows desktop virtuale nativo. Per FSLogix:
<ul>
<li>Distribuzione dell'agente.</li>
<li>Configurazione dei contenitori Office profilo.</li>
...
<strong>L'ambito seguente non è disponibile</strong>
<ul>
<li>Project gestione della distribuzione dell'infrastruttura Windows desktop virtuale del cliente.</li>
<li>Virtualizzazione e distribuzione di app di terze parti.</li>
<li>Creazione di immagini personalizzate per Windows desktop virtuale.</li>
<li>Migrazioni e scenari che coinvolgono VMware e Citrix.</li>
<li>Scenari Linux.</li>
<li>Conversione o migrazione di profili utente.</li>
<li>Microsoft Endpoint Configuration Manager e Microsoft Endpoint Manager per Windows desktop virtuale (inclusa l'applicazione di patch e la gestione). </li>
<li>Microsoft 365 Defender con Windows 10 multi-sessione.</li>
</ul>
Contattare un <a href="https://go.microsoft.com/fwlink/?linkid=2080150">partner Microsoft per</a> assistenza con questi servizi.</td>
<td>Dovresti già disporre di quanto segue:
<ul>
<li><a href="/azure/virtual-desktop/overview#requirements">Windows licenze desktop virtuale</a>.</li>
<li> <a href="/azure/virtual-desktop/overview">L'infrastruttura necessaria per supportare Windows Virtual Deskstop</a>. </li>
<ul>
...
<li>  <strong>Microsoft Edge -</strong> Per istruzioni sulla distribuzione, vedere <a href="/DeployEdge/microsoft-edge-channels">Panoramica dei canali Microsoft Edge distribuzione</a>.  </li>
<li>  <strong>Windows desktop virtuale</strong> - Per ulteriori informazioni, vedere <a href="/azure/virtual-desktop/overview">What is Windows Virtual Desktop?</a> e Windows 10 Enterprise domande frequenti su più <a href="/azure/virtual-desktop/windows-10-multisession-faq">sessioni.</a>  </li>
</ul>
...
<li>  
  Poiché il Web è in continua evoluzione, leggere l'elenco pubblicato delle modifiche note che influiscono sulla compatibilità dei siti <a href="/microsoft-edge/web-platform/site-impacting-changes">per Microsoft Edge</a>.  
  </li>
</ul>
